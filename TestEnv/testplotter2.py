...
fs1,mod1 = wav.read(r'test_file__I_Love_Gaming!__200kHz_16000bps_qam256.wav')
fs2,mod2 = wav.read(r'test_file__I_Love_Gaming!__200kHz_16kbps_qam256_+50kHz_-2rad.wav')
...
#coarse tuning
basem2_complex = basem2_complex**(2**8) # Nth power to demodulate the N order modulation (N = numver of symbols in scheme)
