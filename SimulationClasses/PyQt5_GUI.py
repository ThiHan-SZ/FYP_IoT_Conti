...
from ModulationClass import Modulator  # Reference to Modulator class

class ModulationDialog(QDialog): #dialog box
    def __init__(self):
        super().__init__()
        ...
        # Carrier Frequency Text Input Layout
        ...
        self.carrier_freq_input.editingFinished.connect(self.display_input_values)  # terminal output
        ...
        self.bit_rate_input.editingFinished.connect(self.display_input_values)
        ...
        bpsk_qpsk_layout.addStretch() #left align
        ...
        qam_layout.addStretch() #left align
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.simulation_button.clicked.connect(self.open_demodulation_dialog)
