from PyQt5.QtWidgets import QDialog, QVBoxLayout, QHBoxLayout, QWidget, QPushButton, QLineEdit, QLabel, QTextEdit, QCheckBox, QMessageBox
...
class ModulationDialog(QDialog):
    def __init__(self):
        """
        Initialize the Modulation Dialog.

        This method initializes the Modulation Dialog and sets up the GUI elements, their properties, and layout.
        It also connects the necessary signals and slots for the GUI elements to work properly.
