...
for i in range(64):  # I component (In-Phase)
    for j in range(64):  # Q component (Quadrature)
        ...
        NQAM4096[symbol] = {'I': I_values[i]/(2/3*(4096-1))**0.5, 'Q': Q_values[j]/(2/3*(4096-1))**0.5}

with open('NQAM4096.pkl', 'wb') as f:
    pickle.dump(NQAM4096, f)
...
with open('NQAM4096.pkl', 'rb') as f:
